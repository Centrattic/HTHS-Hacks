...
<p> Nominate a COVID Hero!</p>
<p> In your form, please don't use any inapproriate or spam entries or your nomination will be removed and your account banned. Also, 
    do not write in full sentences when filling out the contact and location sections. </p> 

<br><br>

<div id = "border">
    <p> Upload Your Image of a COVID Hero </p>
    ...
    -->
    <br>
    <p> All About Your Hero (20 words max) </p>
    <p> Ex. Josh Chun is a Millburn High School student who loves plain yogurt, coding, and geometry class. </p> <br>
    <textarea name = "description" rows = 5 cols = 60 placeholder = "Description of Hero's Actions (20 words max)" > </textarea> <br><br>
    <p> Hero's Location </p>
    <p> Ex. 07078 (put only a zip code)</p> <br>
    <textarea name = "location" placeholder = "Hero's Zip Code" rows = 5 cols = 60 maxlength = "300"> </textarea> <br><br>
    <p> What Has Your Hero Done? </p>
    <p> Ex. Josh Chun sews masks and donates them to Goodwill shelters during this period. </p> <br>
    <textarea name = "job" placeholder = "What the Hero has Done (30 words max)" rows = 5 cols = 60 maxlength = "300"> </textarea> <br><br>
    <p> Way to Contact Hero </p>
    <p> Please type only a phone number and/or email address. </p>
    <textarea name = "contact" placeholder = "Hero's Phone Number/Email Address" rows = 5 cols = 60> </textarea> <br><br>
    <button type = "submit" name = "nominate"> Nominate Hero</button>
    <p> Hero's News Links </p>
    <p> Please put, maximum, one news link of your hero's. </p>
    <textarea name = "news" placeholder = "News URL" rows = 3 cols = 60> </textarea> <br><br>
